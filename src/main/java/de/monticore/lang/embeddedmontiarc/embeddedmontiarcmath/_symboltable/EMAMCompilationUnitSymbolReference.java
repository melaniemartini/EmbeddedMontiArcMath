...
public class EMAMCompilationUnitSymbolReference extends EMAMCompilationUnitSymbol implements SymbolReference<EMAMCompilationUnitSymbol> {
  ...
  public EMAMCompilationUnitSymbolReference(final String name, final Scope enclosingScopeOfReference) {
    super(name);
    reference = new CommonSymbolReference<>(name, EMAMCompilationUnitSymbol.KIND, enclosingScopeOfReference);
  }
  ...
  @Override
  public EMAMCompilationUnitSymbol getReferencedSymbol() {
